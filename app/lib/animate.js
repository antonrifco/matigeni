angular.module('ngAnimate-animate.css', ['ngAnimate'])
                ...
                return function(baseClass, classNames) {
                    ...
                    return {
                        ...
                        leave: function(element, done) {
                            animateCSSStart(element, classNames.leave, null, done);
        ...
        .animation('.dn-tada', ['animateCSSBuild', function(animateCSSBuild) {
                return animateCSSBuild('dn-tada', 'tada', 'tada');
            }])

        .animation('.dn-pulse', ['animateCSSBuild', function(animateCSSBuild) {
                return animateCSSBuild('dn-pulse', 'pulse', 'pulse');
            }])

        .animation('.dn-pulse-in', ['animateCSSBuild', function(animateCSSBuild) {
                return animateCSSBuild('dn-pulse', 'pulse', 'fadeOut');
            }])
